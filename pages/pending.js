  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#030014] text-white overflow-hidden text-center px-6">
      ...
      <div className="relative z-10">
        <h1 className="text-4xl font-bold text-yellow-400 mb-4">Pago en proceso</h1>
        <p className="text-gray-300 mb-8">
          Tu pago aún está siendo procesado. Te notificaremos por correo cuando se confirme.
        </p>
        <a
          href="/"
